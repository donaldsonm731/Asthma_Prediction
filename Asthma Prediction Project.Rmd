...
```{r}
model1 <- lmer(ACT ~ wind + gender + age + ODJ + ODA + smoking +  pressure  + temp + hum + uv +  (1|loc) + (1|subject) , data = train)

step_res <- step(model1)
...
```{r}
model2 <- lmer(ACT ~ wind + gender + age + ODJ +  pressure + hum + uv + (1|subject) , data = train)
...
model1 = lmer(ACT ~ wind + gender + age + ODJ + ODA + smoking +  pressure  + temp + hum +  (1|subject) , data = train)
