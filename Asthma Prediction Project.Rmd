...
D
```
# I don't think distance should be used here because we are working in a high dimension
# But kept them in to discuss.
...
featureVector = eigen$vectors[,1:7] # Getting features we want
...
randomForest(train[,1:7], train[,8])
