...
index_UV = which(asthmaData$UVIndex == 0)
index_pressure = which(asthmaData$Pressure == 1003)


index = intersect(index_smoking,intersect(index_gender,intersect(index_age, index_outDoorAct)))
index
