...
train1 <- train[(train$UserNo.!= 9),] 
train2 <- train[(train$UserNo.!= 7),] 
train3 <- train[(train$UserNo.!= 6),] 
train4 <- train[(train$UserNo.!= 5),] 
train5 <- train[(train$UserNo.!= 3),] 
train6 <- train[(train$UserNo.!= 2),] 
train7 <- train[(train$UserNo.!= 1),] 

training <- list(train1,train2,train3,train4,train5,train6,train7)

set.seed(23)
train_control <- trainControl(method = "LOOCV")
model <- train(ACTScore ~., data = train,
               method = "lm",
