...
The anova table below shows use which model is most significant. between fixed effects model and which random effects model.
```{r}
...
mixed_model_formulas <- c("ACTScore ~ 1",
                          "ACTScore ~ (1|UserNo.)",
                          "ACTScore ~ (1|Location)",
                          "ACTScore ~ (1|UserNo.) + (1|Location)")
