...
fit$lambda[30]
fit$df[30]
coef(fit, s = 0.5) # coeff with 50% sparsity. (I think). It shows 5 features and is confirmed on the plot that it is the features that break away from the middle line the fastest. 
