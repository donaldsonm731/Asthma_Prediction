...
model.lm.loocv <- train(x = train[,3:12], y = train[,13], 
                   method = "lm", family = "gaussian",
                   trControl = tc_grouped)

model.lm.loocv$results
#train_control <- trainControl(method = "LOOCV")
#model.lm.loocv<- train(ACTScore ~ WindSpeed + Humidity + Gender + OutdoorJob + 
 #   Pressure + UVIndex, data = train, method = "lm",trControl = train_control)
#print(model.lm.loocv)
```
